...
/**
 * Instantiate a Style with style properties
 * nested inside `fn`.
 *
 * @param {Object} data
 * @param {Function} fn
...
Style.prototype.__proto__  = Emitter.prototype;
...
Style.prototype.append = function(str){
...
Style.prototype.error = function(msg, obj){
...
Style.prototype.inherit = function() {
...
Style.prototype.parse = function(str) {
...
Style.prototype.set = function(id, options) {
...
Style.prototype.trait = function(str, fn) {
...
Style.prototype.text = function(str, fn) {
  for (var i = 0; i < 20; i++) {
    var n = i == 0 ? '' : i;
    var id = 'text' + n
    if (!~this.order.indexOf(id)) break;
...
Style.prototype.setupTrait = function(id, options) {
  var name = unid(id);
...
Style.prototype.setupTraitOptions = function(item, options) {
...
Style.prototype.parseVisibility = function(trait, id){
...
Style.prototype.either = function() {
...
Style.prototype.atleast = function(){
  var args = argify(arguments);
  var all = args.ids;
...
Style.prototype.requires = function(){
  var args = argify(arguments);
  var ids = args.ids;
  var opts = args.opts;
  var count = [];
...
Style.prototype.getRequires = function(ids){
...
Style.prototype.deRequires = function(){
...
Style.prototype.show = function(ids) {
  var ids = argify(arguments).ids;
  this.deRequires(ids);
  this.requires(ids);
...
Style.prototype.optional = function() {
  var ids = argify(arguments).ids;
  this.deRequires(ids);
...
Style.prototype.setVisibility = function(ids, visib) {
...
Style.prototype.validator = function(str, fn){
...
Style.prototype.has = function(ids){
  var failed;
...
Style.prototype.move = function(id, pos){
